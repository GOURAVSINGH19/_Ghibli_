...
const Home = () => {
    return (
        <section className='w-full h-1/2 flex items-center mt-[4vw] flex-col mb-10'>
            <div className='mt-10 backdrop-blur-2xl bg-white/10 border border-white/10 w-[30%] px-4 py-1/2 rounded-2xl flex items-center justify-center gap-3 mb-5 shadow-[var(--shadow-sm)]'>
