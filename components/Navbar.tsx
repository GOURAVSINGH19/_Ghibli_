    ...
    return (
        <header className="w-full fixed top-[.5rem] left-0 z-50 text-sm">
            <nav className=" max-w-screen-xl mx-auto p-[.8rem] px-[2rem]  rounded-[1rem] gap-10 flex justify-between items-center">
                <div className="font-semibold w-fit">_Ghibli_</div>
                <ul className="w-full flex gap-6 font-medium ">
                    <li className="cursor-pointer">Docs</li>
                    <li className="cursor-pointer">Components</li>
                    <li className="cursor-pointer">Charts</li>
                </ul>
                <div className="flex">
                    <div onClick={() => setOpen(!Open)} className=" flex  justify-between cursor-default relative items-center w-[20vw] h-[2em] bg-[var(--bg-light)] shadow-[var(--shadow-s)] rounded-lg  px-[1rem] py-[1rem] outline-0 text-sm" >
